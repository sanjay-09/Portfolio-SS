  ...
  return (
    <div className='border-b border-neutral-800 pb-24'>
        ...
        <motion.div whileInView={{opacity:1,x:0}} initial={{opacity:0,x:-100}} transition={{duration:1.5}} className='flex flex-wrap items-center justify-center gap-4'>
            ...
            <motion.div variants={iconVariant(6)} className='rounded-2xl border-4 border-neutral-800 p-4'>
            ...
            <motion.div  variants={iconVariant(4)} initial="initial" animate="animate" className='rounded-2xl border-4 border-neutral-800 p-4'>
                <TbFileTypeSql className="text-7xl text-cyan-400"/>
            </motion.div>
            ...
            <motion.div  variants={iconVariant(4.5)} initial="initial" animate="animate" className='rounded-2xl border-4 border-neutral-800 p-4'>
